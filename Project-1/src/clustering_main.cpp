...
int main(int argc, char *argv[]) {
    ...
    string data_file;
    string data_file_original = "test_set";
    string conf_file;
    string output_file;
    string method;
    int CompleteFlag = 0;
    ...
    vector<pair<int, vector<unsigned int>*>> dataset_original;
    Functions::readImages(data_file_original, dataset_original);
    
    Clustering Cl(dataset, dataset_original, conf_file);
    //Cl.print();
